...
# driver.find_element(By.ID, "username").send_keys("kiko")
# driver.find_element(By.ID, "password").send_keys("1234560")
# driver.find_element(By.ID, "email").send_keys("sass67@gmail.com")
# driver.find_element(By.ID, "phone").send_keys("1234567880")
# driver.find_element(By.ID, "address").send_keys("123 Main St")
# driver.find_element(By.ID, "register-btn").click()
...
#     add1 = driver.find_element(By.ID, "add-to-cart-1")
#     driver.execute_script("arguments[0].click();", add1)
#     driver.execute_script("arguments[0].click();", add1)

#     add2 = driver.find_element(By.ID, "add-to-cart-2")
#     driver.execute_script("arguments[0].click();", add2)
#     driver.execute_script("arguments[0].click();", add2)
#     driver.execute_script("arguments[0].click();", add2)
...
#         By.XPATH,
#         "//*[contains(text(), 'Order placed successfully!')]"
#     )
...
#     try:
#         invalid_meal = driver.find_element(By.ID, "add-to-cart-9999")

#         driver.execute_script("arguments[0].click();", invalid_meal)
...
#         print("TC-FUNC-037 FAILED - Invalid meal button exists")

#     except NoSuchElementException:
#         print("TC-FUNC-037 PASSED - Non-existent meal correctly rejected")

# except Exception as e:
#     print("TC-FUNC-037 FAILED")
#     print(e)
...
#     remove_btn = driver.find_element(By.ID, "remove-from-cart-1")
#     driver.execute_script("arguments[0].click();", remove_btn)

#     time.sleep(1)

#     remove_buttons = driver.find_elements(By.ID, "remove-from-cart-1")
...
# driver.find_element(By.ID, "login-btn").click()
# time.sleep(3)
# addbtu = driver.find_element(By.ID, 'add-to-cart-4')
# driver.execute_script("arguments[0].click();", addbtu)
# cart_btn = driver.find_element(By.ID, 'cart-btn')
# driver.execute_script("arguments[0].click();", cart_btn)
# time.sleep(1)
...
#     message = log['message']
#     if (
#         'Image is missing required "src" property' in message
#         or 'An empty string ("") was passed to the %s attribute' in message
#     ):
#         continue
...
# # Assertions
# assert len(real_errors) == 0, f"Real JS errors found: {real_errors}"
# assert len(order_cards) > 0

# print(f"TC-PERF-008 PASSED - Orders page rendered {len(order_cards)} cards with no real JS errors")
