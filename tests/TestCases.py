...
# TC-USA-002  |  Error message visible on failed register  (File 7)
# driver.get(f"{BASE_URL}/login?mode=signup")
# time.sleep(2)
# driver.find_element(By.ID, "username").send_keys("sami2")
# driver.find_element(By.ID, "password").send_keys("123456")
...
# Navigate from Sign-In to Sign-Up page  (File 4)
# try:
...
# Navigate from Registration to Login  (File 4)
# try:
#     driver.get(f"{BASE_URL}/login?mode=signup")
#     time.sleep(3)
#     print(driver.current_url)
...
#     time.sleep(2)
#     assert "/login" not in driver.current_url
#     print("TC-003 PASSED - navigation from registration to login rejected (expected?)")
# except AssertionError:
#     print("TC-003 FAILED - navigating accepted")
...
# TC-USA-001  |  Error message visible on failed login  (File 7)
# driver.get(f"{BASE_URL}/login")
# time.sleep(2)
# driver.find_element(By.ID, "username").send_keys("sami2")
# driver.find_element(By.ID, "password").send_keys("wrongpassword")
...
# Add meal to cart — verifies total price  (File 4)
# try:
#     driver.get(f"{BASE_URL}")
#     time.sleep(2)
...
# Add same meal multiple times to cart  (File 4)
# try:
#     driver.get(f"{BASE_URL}")
#     time.sleep(2)
#     meal1 = driver.find_element(By.ID, 'add-to-cart-1')
...
# Removing meal from cart (quantity decrease)  (File 4)
# driver.get(f"{BASE_URL}")
# time.sleep(2)
# addbtu = driver.find_element(By.ID, 'add-to-cart-1')
# driver.execute_script("arguments[0].click();", addbtu)
...
# TC-USA-006  |  Cart bar hidden when cart is empty  (File 7)
# driver.get(f"{BASE_URL}/")
# time.sleep(3)
# cart_btn = driver.find_element(By.ID, 'cart-btn')
...
# TC-USA-007  |  Cart bar appears after adding item  (File 7)
# driver.get(f"{BASE_URL}/")
# time.sleep(3)
# addbtu = driver.find_element(By.ID, 'add-to-cart-1')
# driver.execute_script("arguments[0].click();", addbtu)
...
# TC-FUNC-014  |  Close cart modal  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
cart_btn = driver.find_element(By.ID, 'add-to-cart-3')
driver.execute_script("arguments[0].click();", cart_btn)
...
# TC-FUNC-038  |  Cart modal shows empty state message  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
time.sleep(2)
...
# TC-FUNC-037  |  Cart modal shows correct number of items  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
time.sleep(3)
addbtu1 = driver.find_element(By.ID, 'add-to-cart-1')
driver.execute_script("arguments[0].click();", addbtu1)
...
# TC-FUNC-043  |  Cart item IDs present in modal  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
time.sleep(3)
addbtu = driver.find_element(By.ID, 'add-to-cart-1')
driver.execute_script("arguments[0].click();", addbtu)
...
# TC-FUNC-046  |  Place order when not logged in shows error  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
clear_local_storage()
time.sleep(3)
addbtu = driver.find_element(By.ID, 'add-to-cart-1')
...
# Open cart via nav button  (File 4)
# try:
#     driver.get(f"{BASE_URL}")
#     time.sleep(1)
...
# Increasing item quantity via cart modal  (File 4)
# try:
#     driver.get(f"{BASE_URL}")
#     time.sleep(1)
...
# Decreasing item quantity via cart modal  (File 4)
# try:
#     driver.get(f"{BASE_URL}")
#     time.sleep(1)
#     addbtu = driver.find_element(By.ID, 'add-to-cart-3')
...
# Completely removing a meal  (File 4)
# driver.get(f"{BASE_URL}")
# time.sleep(3)
# addbtu = driver.find_element(By.ID, 'add-to-cart-1')
# driver.execute_script("arguments[0].click();", addbtu)
...
# TC-USA-010  |  Empty cart message and disabled button in modal  (File 7)
# driver.get(f"{BASE_URL}/")
# time.sleep(2)
# nav_cart = driver.find_element(By.ID, 'nav-cart-btn')
# driver.execute_script("arguments[0].click();", nav_cart)
...
# TC-FUNC-015  |  Create order with valid data  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
...
# TC-FUNC-016  |  Create order with non-existent meal  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
...
# TC-FUNC-017  |  Create order with multiple items  (File 4)
# try:
#     driver.find_element(By.ID, "add-to-cart-1").click()
#     driver.find_element(By.ID, "add-to-cart-1").click()
...
# TC-FUNC-019  |  Get orders for non-existent user  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
...
# TC-FUNC-020  |  Create order with quantity = 0  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
#     driver.find_element(By.ID, "add-to-cart-1").click()
#     driver.find_element(By.ID, "cart-btn").click()
...
# TC-FUNC-021  |  Create order with negative quantity  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
#     driver.find_element(By.ID, "add-to-cart-1").click()
#     driver.find_element(By.ID, "cart-btn").click()
...
# TC-FUNC-024  |  Verify total price calculation  (File 4)
# try:
#     driver.get(f"{BASE_URL}/")
#     driver.find_element(By.ID, "add-to-cart-1").click()
#     driver.find_element(By.ID, "add-to-cart-1").click()
...
# BR-010  |  Order confirmation shown after successful order  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-FUNC-049  |  View My Orders page  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-FUNC-050  |  Order cards present in DOM  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-FUNC-051  |  Order card shows title and price  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-FUNC-052  |  Grand total section visible on orders page  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-FUNC-053  |  No orders message for user with no orders  *** ACTIVE x2 *** (Files 2 & 5)
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami5")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-USA-014  |  My Orders shows empty state clearly  (File 7)
...
# TC-USA-005  |  Place Order button shows loading state  (File 7)
# driver.get(f"{BASE_URL}/login")
# time.sleep(2)
# driver.find_element(By.ID, "username").send_keys("sami2")
# driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-USA-011  |  Order confirmation message is clear  (File 7)
# driver.get(f"{BASE_URL}/login")
# time.sleep(2)
# driver.find_element(By.ID, "username").send_keys("sami2")
# driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-PERF-005  |  Place order response time  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-PERF-010  |  My Orders page with many orders  *** ACTIVE ***  
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-PERF-011  |  Simultaneous cart operations (10 rapid clicks)  *** ACTIVE ***  
driver.get(f"{BASE_URL}/")
time.sleep(3)
addbtu = driver.find_element(By.ID, 'add-to-cart-1')
for r in range(10):
...
# TC-USA-019  |  Username displayed in navbar after login  *** ACTIVE ***  (File 7)
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
...
# TC-USA-020  |  Page title visible on My Orders page  *** ACTIVE ***  (File 7)
driver.get(f"{BASE_URL}/login")
time.sleep(2)
driver.find_element(By.ID, "username").send_keys("sami2")
driver.find_element(By.ID, "password").send_keys("123456")
